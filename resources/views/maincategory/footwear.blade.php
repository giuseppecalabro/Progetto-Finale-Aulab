<x-layout>
    <x-slot name="title">{{ __('ui.prestoIt') }} - {{ __('ui.footwear') }}</x-slot>

    <section id="slotLayout" class="container-fluid ">
        <div class="row min-vh-100  m-0 bgArticle ">
            <h2 class="text-center my-3 formatTitlePages text-uppercase">{{ __('ui.footwear') }}</h2>
